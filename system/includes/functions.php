...
function get_frontpage()
{
    ...
    if (file_exists($filename)) {
        ...
        $front->title = 'Ankara Eşya Depolama Hizmeti';
        $front->url = site_url() . 'front';
        $front->body = 'Europa Depo olarak, ev eşyalarınızı en güvenli şekilde depoluyoruz. Modern tesislerimiz, 7/24 güvenlik sistemi ve profesyonel ekibimizle eşyalarınız tam güvende. Kısa ve uzun vadeli depolama çözümleri için bize güvenin.';
        $front->file = null;
        $front->slug = 'front';
        $front->parent = null;
        $front->parentSlug = null;
