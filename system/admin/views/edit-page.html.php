...
if ($type == 'is_frontpage') {
    ...
    if (file_exists($filename)) {
        ...
        $content = 'Europa Depo olarak, ev eşyalarınızı en güvenli şekilde depoluyoruz. Modern tesislerimiz, 7/24 güvenlik sistemi ve profesyonel ekibimizle eşyalarınız tam güvende. Kısa ve uzun vadeli depolama çözümleri için bize güvenin.';
        $oldtitle = 'Ankara Eşya Depolama Hizmeti';
        $oldcontent = 'Europa Depo olarak, ev eşyalarınızı en güvenli şekilde depoluyoruz. Modern tesislerimiz, 7/24 güvenlik sistemi ve profesyonel ekibimizle eşyalarınız tam güvende. Kısa ve uzun vadeli depolama çözümleri için bize güvenin.';
    }
