            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url();?>admin/update" class="nav-link">
                  <p>
                    <i class="fa fa-code"></i> HTMLy <?php echo i18n('Check_update'); ?>
                  </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url();?>admin/europa-update" class="nav-link">
                  <p>
                    <i class="fa fa-rocket text-primary"></i> Europa Depo Güncelleme
                  </p>
                </a>
              </li>
              <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        if (function_exists('show_update_notification')) {
            echo show_update_notification();
        }
        ?>
